    ...
    <div className="bg-[var(--Primary-Black)] py-8">
      <div className="max-w-[1512px] w-[90%] mx-auto grid md:grid-cols-4 sm:grid-cols-2 ">
        <div className="flex items-center flex-col md:gap-[26.39px] gap-[20.39px] md:p-[63.34px]">
          ...
          <p className="text-[14.78px] font-[400] text-[var(--Primary-White)]  leading-normal opacity-50 text-justify">
          ...
          <div className="flex gap-[10.557px]">
            <input
              className="p-[10px] border opacity-50  rounded-[211.144px] bg-[var(--Primary-Black)] outline-none "
              type="email"
              placeholder="Type your email address"
            />
            <button className="p-[10px_30px] bg-[var(--Primary-White)] rounded-[211.14px] ">
              Submit
            </button>
          </div>
        </div>
          ...
          <div className="flex gap-[6px]">
            <div className="relative  w-[80px] h-[80px]">
              <Image
                ...
                src="/assets/qrcode/qrcode1.png"
              />
            </div>
            <div>
              <div className="  p-[3px] relative h-[40px] w-[110px]">
                <Image
                  fill
                  className="h-full w-full"
                  src="/assets/qrcode/GooglePlay.png"
                />
              </div>
              <div className=" p-[3px] relative h-[40px] w-[110px]">
                <Image
                  fill
                  className="h-full w-full"
                  src="/assets/qrcode/AppStore.png"
                />
              </div>
            </div>
          </div>
